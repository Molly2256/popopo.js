...
export interface LiveSelectionSequence {
  id: string
  sequenceId: string
  documentPath: string
  kind?: string
...
export interface LiveSelectionSequenceListOptions {
  limit?: number
  orderBy?: string
  pageToken?: string
}

export interface LiveSelectionSequenceListResult {
  sequences: LiveSelectionSequence[]
  nextPageToken?: string
  raw: Record<string, unknown>
}
...
export interface ReceiveLatestPresentResult {
  notification: PersonalNotificationData
  response: PersonalNotificationDeliveryContent
}
...
export interface FirebaseEmailPasswordSignUpRequest extends FirebaseEmailPasswordCredentials {
  displayName?: string
  persistSession?: boolean
}

export interface FirebaseEmailPasswordSignInRequest extends FirebaseEmailPasswordCredentials {
  persistSession?: boolean
}
